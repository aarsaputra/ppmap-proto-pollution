...
class Tier8ClobberingScanner(BaseTierScanner):
    ...
    def run(self, ctx: ScanContext) -> List[Finding]:
        ...
        try:
            ...
            for clobber_payload in clobber_payloads:
                # Injection
                ...
                if baseline.status_code < 400 and resp.status_code >= 500:
                    ...
                    break # Stop testing payloads if one succeeded
        ...
        if ctx.driver:
            try:
                ...
                for payload_suffix in url_payloads:
                    safe_url = target_url
                    if "?" in payload_suffix and "?" in safe_url:
                        safe_url += "&" + payload_suffix[1:]
                    else:
                        safe_url += payload_suffix
