...
class RateLimiter:
    ...
    def wait(self):
        ...
        if elapsed < self.min_interval:
            ...
            logger.debug(
                f"RateLimiter: Sleeping for {sleep_time:.2f}s to respect limit"
            )
        ...
        def wrapper(*args, **kwargs):
            ...
            if args and hasattr(args[0], "config"):
                ...
                if instance_id not in _limiters:
                    ...
                    _limiters[instance_id] = RateLimiter(
                        requests_per_minute=rpm, delay_seconds=delay
                    )
                ...
                limiter = RateLimiter(
                    requests_per_minute=requests_per_minute, delay_seconds=delay_seconds
                )
