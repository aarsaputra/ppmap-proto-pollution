...
class GraphQLScanner:
    ...
    def test_mutation_pp(self, endpoint: str, 
                         custom_payloads: Optional[List[Dict]] = None) -> List[GraphQLFinding]:
        """
        ...
        for payload in payloads:
            try:
                ...
                finding = self._analyze_response(
                    endpoint, 'mutation', payload, resp
                )
                if finding:
    ...
    def test_query_pp(self, endpoint: str,
                      custom_payloads: Optional[List[Dict]] = None) -> List[GraphQLFinding]:
        """
    ...
    def _analyze_response(self, endpoint: str, op_type: str,
                          payload: Dict, response: requests.Response) -> Optional[GraphQLFinding]:
